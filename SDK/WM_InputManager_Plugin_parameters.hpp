...
static_assert(alignof(WM_ControllerFunctionLib_GetKeyName) == 0x000008, "Wrong alignment on WM_ControllerFunctionLib_GetKeyName");
static_assert(sizeof(WM_ControllerFunctionLib_GetKeyName) == 0x000020, "Wrong size on WM_ControllerFunctionLib_GetKeyName");
static_assert(offsetof(WM_ControllerFunctionLib_GetKeyName, InKey) == 0x000000, "Member 'WM_ControllerFunctionLib_GetKeyName::InKey' has a wrong offset!");
static_assert(offsetof(WM_ControllerFunctionLib_GetKeyName, ReturnValue) == 0x000018, "Member 'WM_ControllerFunctionLib_GetKeyName::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WM_Device_HID_GetRaw_AxisData) == 0x0000A0, "Wrong size on WM_Device_HID_GetRaw_AxisData");
...
// DelegateFunction WM_InputManager_Plugin.WM_InputManager.GetActiveDevice__DelegateSignature
// 0x0004 (0x0004 - 0x0000)
struct WM_InputManager_GetActiveDevice__DelegateSignature final
{
public:
	int32                                         ReturnValue;                                       // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(WM_InputManager_GetActiveDevice__DelegateSignature) == 0x000004, "Wrong alignment on WM_InputManager_GetActiveDevice__DelegateSignature");
static_assert(sizeof(WM_InputManager_GetActiveDevice__DelegateSignature) == 0x000004, "Wrong size on WM_InputManager_GetActiveDevice__DelegateSignature");
static_assert(offsetof(WM_InputManager_GetActiveDevice__DelegateSignature, ReturnValue) == 0x000000, "Member 'WM_InputManager_GetActiveDevice__DelegateSignature::ReturnValue' has a wrong offset!");
...
static_assert(alignof(WM_InputManager_GetActiveHID) == 0x000008, "Wrong alignment on WM_InputManager_GetActiveHID");
static_assert(sizeof(WM_InputManager_GetActiveHID) == 0x000008, "Wrong size on WM_InputManager_GetActiveHID");
static_assert(offsetof(WM_InputManager_GetActiveHID, ReturnValue) == 0x000000, "Member 'WM_InputManager_GetActiveHID::ReturnValue' has a wrong offset!");
