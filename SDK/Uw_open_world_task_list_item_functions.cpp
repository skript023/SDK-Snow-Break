...
#include "Uw_open_world_task_list_item_classes.hpp"
#include "Uw_open_world_task_list_item_parameters.hpp"
...
void UUw_open_world_task_list_item_C::OnListItemObjectSet(class UObject* ListItemObject)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("uw_open_world_task_list_item_C", "OnListItemObjectSet");

	Params::Uw_open_world_task_list_item_C_OnListItemObjectSet Parms{};
...
class FString UUw_open_world_task_list_item_C::GetModuleName() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("uw_open_world_task_list_item_C", "GetModuleName");

	Params::Uw_open_world_task_list_item_C_GetModuleName Parms{};
