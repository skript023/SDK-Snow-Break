...
#include "SkillMove_DragToLoc_Update_classes.hpp"
#include "SkillMove_DragToLoc_Update_parameters.hpp"
...
class FString USkillMove_DragToLoc_Update_C::GetModuleName() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SkillMove_DragToLoc_Update_C", "GetModuleName");

	Params::SkillMove_DragToLoc_Update_C_GetModuleName Parms{};
