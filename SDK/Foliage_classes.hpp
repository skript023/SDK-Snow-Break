...
static_assert(sizeof(UFoliageInstancedStaticMeshComponent) == 0x0006D0, "Wrong size on UFoliageInstancedStaticMeshComponent");
...
static_assert(offsetof(UFoliageInstancedStaticMeshComponent, GenerationGuid) == 0x0006B8, "Member 'UFoliageInstancedStaticMeshComponent::GenerationGuid' has a wrong offset!");
