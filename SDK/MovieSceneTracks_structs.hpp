...
static_assert(offsetof(FMovieSceneComponentMaterialSectionTemplate, PassIndex) == 0x000084, "Member 'FMovieSceneComponentMaterialSectionTemplate::PassIndex' has a wrong offset!");
...
static_assert(alignof(FMovieSceneSubtitleInfo) == 0x000004, "Wrong alignment on FMovieSceneSubtitleInfo");
static_assert(sizeof(FMovieSceneSubtitleInfo) == 0x000008, "Wrong size on FMovieSceneSubtitleInfo");
static_assert(offsetof(FMovieSceneSubtitleInfo, Key) == 0x000000, "Member 'FMovieSceneSubtitleInfo::Key' has a wrong offset!");
...
static_assert(alignof(FMovieSceneSubtitleChannel) == 0x000008, "Wrong alignment on FMovieSceneSubtitleChannel");
static_assert(sizeof(FMovieSceneSubtitleChannel) == 0x000088, "Wrong size on FMovieSceneSubtitleChannel");
static_assert(offsetof(FMovieSceneSubtitleChannel, KeyTimes) == 0x000008, "Member 'FMovieSceneSubtitleChannel::KeyTimes' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubtitleChannel, KeyValues) == 0x000018, "Member 'FMovieSceneSubtitleChannel::KeyValues' has a wrong offset!");
...
static_assert(alignof(FMovieSceneSubtitleTriggerData) == 0x000004, "Wrong alignment on FMovieSceneSubtitleTriggerData");
static_assert(sizeof(FMovieSceneSubtitleTriggerData) == 0x000024, "Wrong size on FMovieSceneSubtitleTriggerData");
static_assert(offsetof(FMovieSceneSubtitleTriggerData, Key) == 0x000000, "Member 'FMovieSceneSubtitleTriggerData::Key' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubtitleTriggerData, ObjectBindingID) == 0x000008, "Member 'FMovieSceneSubtitleTriggerData::ObjectBindingID' has a wrong offset!");
...
static_assert(alignof(FMovieSceneSubtitleSectionTemplate) == 0x000008, "Wrong alignment on FMovieSceneSubtitleSectionTemplate");
static_assert(sizeof(FMovieSceneSubtitleSectionTemplate) == 0x000028, "Wrong size on FMovieSceneSubtitleSectionTemplate");
