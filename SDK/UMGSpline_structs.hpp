...
static_assert(alignof(FUMGSplinePoint) == 0x000004, "Wrong alignment on FUMGSplinePoint");
static_assert(sizeof(FUMGSplinePoint) == 0x000010, "Wrong size on FUMGSplinePoint");
static_assert(offsetof(FUMGSplinePoint, Location) == 0x000000, "Member 'FUMGSplinePoint::Location' has a wrong offset!");
static_assert(offsetof(FUMGSplinePoint, Direction) == 0x000008, "Member 'FUMGSplinePoint::Direction' has a wrong offset!");
...
static_assert(alignof(FUMGSplineInfo) == 0x000008, "Wrong alignment on FUMGSplineInfo");
static_assert(sizeof(FUMGSplineInfo) == 0x0000C0, "Wrong size on FUMGSplineInfo");
...
static_assert(offsetof(FUMGSplineInfo, CustomVertsVCoordScale) == 0x0000B8, "Member 'FUMGSplineInfo::CustomVertsVCoordScale' has a wrong offset!");
