...
{
public:
	FMulticastInlineDelegateProperty_             OnCameraCut;                                       // 0x06C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_6D0[0x108];                                    // 0x06D0(0x0108)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULevelSequencePlayer) == 0x0007D8, "Wrong size on ULevelSequencePlayer");
static_assert(offsetof(ULevelSequencePlayer, OnCameraCut) == 0x0006C0, "Member 'ULevelSequencePlayer::OnCameraCut' has a wrong offset!");
