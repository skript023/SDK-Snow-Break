...
static_assert(alignof(NiagaraComponent_SetQualityLevelBias) == 0x000004, "Wrong alignment on NiagaraComponent_SetQualityLevelBias");
static_assert(sizeof(NiagaraComponent_SetQualityLevelBias) == 0x000004, "Wrong size on NiagaraComponent_SetQualityLevelBias");
static_assert(offsetof(NiagaraComponent_SetQualityLevelBias, Bias) == 0x000000, "Member 'NiagaraComponent_SetQualityLevelBias::Bias' has a wrong offset!");
...
static_assert(sizeof(NiagaraFunctionLibrary_SpawnSystemAtLocation) == 0x000048, "Wrong size on NiagaraFunctionLibrary_SpawnSystemAtLocation");
...
static_assert(offsetof(NiagaraFunctionLibrary_SpawnSystemAtLocation, QLBias) == 0x000038, "Member 'NiagaraFunctionLibrary_SpawnSystemAtLocation::QLBias' has a wrong offset!");
static_assert(offsetof(NiagaraFunctionLibrary_SpawnSystemAtLocation, ReturnValue) == 0x000040, "Member 'NiagaraFunctionLibrary_SpawnSystemAtLocation::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(NiagaraFunctionLibrary_SpawnSystemAttached, QLBias) == 0x000038, "Member 'NiagaraFunctionLibrary_SpawnSystemAttached::QLBias' has a wrong offset!");
