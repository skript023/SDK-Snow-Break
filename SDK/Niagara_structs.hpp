...
static_assert(offsetof(FNiagaraPlatformSet, PlatformMask) == 0x000000, "Member 'FNiagaraPlatformSet::PlatformMask' has a wrong offset!");
static_assert(offsetof(FNiagaraPlatformSet, QualityLevelMask) == 0x000004, "Member 'FNiagaraPlatformSet::QualityLevelMask' has a wrong offset!");
...
static_assert(offsetof(FNiagaraEventScriptProperties, SpawnRate) == 0x000054, "Member 'FNiagaraEventScriptProperties::SpawnRate' has a wrong offset!");
