...
static_assert(offsetof(PlayMontageCallbackProxy_OnMontageEnded, InstanceId) == 0x00000C, "Member 'PlayMontageCallbackProxy_OnMontageEnded::InstanceId' has a wrong offset!");
