...
#include "Uw_fight_plm_frame_classes.hpp"
#include "Uw_fight_plm_frame_parameters.hpp"
...
void UUw_fight_plm_frame_C::K2_OnReloading(bool bIsReload, EWeaponType Type, bool bInterrupt, float AnimTime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("uw_fight_plm_frame_C", "K2_OnReloading");

	Params::Uw_fight_plm_frame_C_K2_OnReloading Parms{};
