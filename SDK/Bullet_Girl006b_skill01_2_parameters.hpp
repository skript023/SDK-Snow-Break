...
struct Bullet_Girl006b_skill01_2_C_ExecuteUbergraph_Bullet_Girl006b_skill01_2 final
{
public:
	...
	struct FVector                                CallFunc_GetQueryTargetLocation_ReturnValue;       // 0x0028(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_34[0x4];                                       // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UNiagaraComponent*                      CallFunc_SpawnNiagaraAtLocationPath_ReturnValue;   // 0x0038(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class ATrap*>                          CallFunc_GetValidTrapListBySummonerAndTrapName_ReturnValue; // 0x00A8(0x0010)(ReferenceParm)
	class ATrap*                                  CallFunc_Array_Get_Item;                           // 0x00B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ATrap_Girl006b_skill01_2_C*             K2Node_DynamicCast_AsTrap_Girl_006b_Skill_01_2;    // 0x00C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_Bullet_Girl006b_skill01_2_C_ExecuteUbergraph_Bullet_Girl006b_skill01_2;
