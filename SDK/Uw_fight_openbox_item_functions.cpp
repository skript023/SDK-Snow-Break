...
#include "Uw_fight_openbox_item_classes.hpp"
#include "Uw_fight_openbox_item_parameters.hpp"


namespace SDK
{

// LuaFunction uw_fight_openbox_item.uw_fight_openbox_item_C.UpdateKeyShow
// (Native, Public, BlueprintCallable, BlueprintEvent)

void UUw_fight_openbox_item_C::UpdateKeyShow()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("uw_fight_openbox_item_C", "UpdateKeyShow");
...
void UUw_fight_openbox_item_C::TriggerInteract()
{
	static class UFunction* Func = nullptr;
...
void UUw_fight_openbox_item_C::BindKeyBoardOnSettingChange()
{
	static class UFunction* Func = nullptr;
...
// Function uw_fight_openbox_item.uw_fight_openbox_item_C.GetModuleName
// (Event, Public, HasOutParams, BlueprintCallable, BlueprintEvent, Const)
// Parameters:
// class FString                           ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash)

class FString UUw_fight_openbox_item_C::GetModuleName() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("uw_fight_openbox_item_C", "GetModuleName");

	Params::Uw_fight_openbox_item_C_GetModuleName Parms{};
