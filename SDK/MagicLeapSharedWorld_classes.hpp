...
public:
	...
	FMulticastInlineDelegateProperty_             OnNewLocalDataFromClients;                         // 0x0320(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
