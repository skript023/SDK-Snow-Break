...
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffect, bAbsoluteScale) == 0x000064, "Member 'UAnimNotifyState_TimedNiagaraEffect::bAbsoluteScale' has a wrong offset!");
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffect, bDestroyAtEnd) == 0x000065, "Member 'UAnimNotifyState_TimedNiagaraEffect::bDestroyAtEnd' has a wrong offset!");
