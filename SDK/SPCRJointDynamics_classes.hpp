...
static_assert(sizeof(USPCRJointDynamicsComponent) == 0x0000B8, "Wrong size on USPCRJointDynamicsComponent");
static_assert(offsetof(USPCRJointDynamicsComponent, IsReset) == 0x0000B0, "Member 'USPCRJointDynamicsComponent::IsReset' has a wrong offset!");
...
static_assert(sizeof(USPCRJointDynamicsMngComponent) == 0x0000C0, "Wrong size on USPCRJointDynamicsMngComponent");
...
static_assert(sizeof(USPCRJointDynamicsRuntimeSettings) == 0x000028, "Wrong size on USPCRJointDynamicsRuntimeSettings");
...
static_assert(sizeof(USPCRJointDynamicsStaticFunctions) == 0x000028, "Wrong size on USPCRJointDynamicsStaticFunctions");
