...
static_assert(alignof(FStreamingLevelActorListCollection) == 0x000008, "Wrong alignment on FStreamingLevelActorListCollection");
static_assert(sizeof(FStreamingLevelActorListCollection) == 0x000090, "Wrong size on FStreamingLevelActorListCollection");
