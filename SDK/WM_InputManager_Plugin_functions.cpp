...
int32 UWM_InputManager::GetActiveDevice__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WM_InputManager", "GetActiveDevice__DelegateSignature");

	Params::WM_InputManager_GetActiveDevice__DelegateSignature Parms{};
