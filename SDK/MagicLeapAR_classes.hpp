...
static_assert(sizeof(ALuminAROrigin) == 0x0002E8, "Wrong size on ALuminAROrigin");
static_assert(offsetof(ALuminAROrigin, MRMeshComponent) == 0x000228, "Member 'ALuminAROrigin::MRMeshComponent' has a wrong offset!");
static_assert(offsetof(ALuminAROrigin, PlaneSurfaceMaterial) == 0x000230, "Member 'ALuminAROrigin::PlaneSurfaceMaterial' has a wrong offset!");
static_assert(offsetof(ALuminAROrigin, WireframeMaterial) == 0x000238, "Member 'ALuminAROrigin::WireframeMaterial' has a wrong offset!");
