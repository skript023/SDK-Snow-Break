...
static_assert(offsetof(UWheeledVehicleMovementComponent4W, FrontAntiRollStiffness) == 0x000408, "Member 'UWheeledVehicleMovementComponent4W::FrontAntiRollStiffness' has a wrong offset!");
static_assert(offsetof(UWheeledVehicleMovementComponent4W, RearAntiRollStiffness) == 0x00040C, "Member 'UWheeledVehicleMovementComponent4W::RearAntiRollStiffness' has a wrong offset!");
