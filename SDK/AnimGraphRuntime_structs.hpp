...
static_assert(offsetof(FAnimNode_SequenceEvaluator, bResetWhenTimeJumpNegative) == 0x000047, "Member 'FAnimNode_SequenceEvaluator::bResetWhenTimeJumpNegative' has a wrong offset!");
