...
static_assert(offsetof(UMovieSceneComponentMaterialTrack, PassIndex) == 0x000094, "Member 'UMovieSceneComponentMaterialTrack::PassIndex' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneSubtitleSection) == 0x000178, "Wrong size on UMovieSceneSubtitleSection");
static_assert(offsetof(UMovieSceneSubtitleSection, SubtitleChannel) == 0x0000F0, "Member 'UMovieSceneSubtitleSection::SubtitleChannel' has a wrong offset!");
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieSceneSubtitleSystem">();
	}
...
static_assert(alignof(UMovieSceneSubtitleSystem) == 0x000008, "Wrong alignment on UMovieSceneSubtitleSystem");
static_assert(sizeof(UMovieSceneSubtitleSystem) == 0x000090, "Wrong size on UMovieSceneSubtitleSystem");
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieScenePostEvalSubtitleSystem">();
	}
...
static_assert(alignof(UMovieScenePostEvalSubtitleSystem) == 0x000008, "Wrong alignment on UMovieScenePostEvalSubtitleSystem");
static_assert(sizeof(UMovieScenePostEvalSubtitleSystem) == 0x000090, "Wrong size on UMovieScenePostEvalSubtitleSystem");
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"MovieSceneSubtitleTrack">();
	}
...
static_assert(alignof(UMovieSceneSubtitleTrack) == 0x000008, "Wrong alignment on UMovieSceneSubtitleTrack");
static_assert(sizeof(UMovieSceneSubtitleTrack) == 0x000098, "Wrong size on UMovieSceneSubtitleTrack");
static_assert(offsetof(UMovieSceneSubtitleTrack, Sections) == 0x000088, "Member 'UMovieSceneSubtitleTrack::Sections' has a wrong offset!");
