...
static_assert(alignof(USplineWidget) == 0x000008, "Wrong alignment on USplineWidget");
static_assert(sizeof(USplineWidget) == 0x000248, "Wrong size on USplineWidget");
static_assert(offsetof(USplineWidget, SplineInfo) == 0x000128, "Member 'USplineWidget::SplineInfo' has a wrong offset!");
static_assert(offsetof(USplineWidget, SplineDebugInfo) == 0x0001E8, "Member 'USplineWidget::SplineDebugInfo' has a wrong offset!");
static_assert(offsetof(USplineWidget, SplineCurves) == 0x000210, "Member 'USplineWidget::SplineCurves' has a wrong offset!");
