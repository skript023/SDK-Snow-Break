...
#include "uw_fight_cross_girlrush3_classes.hpp"
#include "uw_fight_cross_girlrush3_parameters.hpp"
...
void Uuw_fight_cross_girlrush3_C::K2_OnReloading(bool bIsReload, EWeaponType Type, bool bInterrupt, float AnimTime)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("uw_fight_cross_girlrush3_C", "K2_OnReloading");

	Params::uw_fight_cross_girlrush3_C_K2_OnReloading Parms{};
