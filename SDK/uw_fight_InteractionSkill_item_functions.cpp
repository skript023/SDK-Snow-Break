...
#include "uw_fight_InteractionSkill_item_classes.hpp"
#include "uw_fight_InteractionSkill_item_parameters.hpp"
...
// Function uw_fight_InteractionSkill_item.uw_fight_InteractionSkill_item_C.GetModuleName
// (Event, Public, HasOutParams, BlueprintCallable, BlueprintEvent, Const)
// Parameters:
// class FString                           ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash)

class FString Uuw_fight_InteractionSkill_item_C::GetModuleName() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("uw_fight_InteractionSkill_item_C", "GetModuleName");

	Params::uw_fight_InteractionSkill_item_C_GetModuleName Parms{};
