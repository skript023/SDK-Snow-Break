...
static_assert(offsetof(ARecastNavMesh, DetailSampleDist) == 0x0004A4, "Member 'ARecastNavMesh::DetailSampleDist' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, DetailSampleMaxError) == 0x0004A8, "Member 'ARecastNavMesh::DetailSampleMaxError' has a wrong offset!");
