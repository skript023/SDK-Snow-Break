...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0745F858;
	constexpr int32 AppendString      = 0x026B7750;
	constexpr int32 GNames            = 0x07446FC0;
	constexpr int32 GWorld            = 0x075AEC18;
	constexpr int32 ProcessEvent      = 0x028D3140;
