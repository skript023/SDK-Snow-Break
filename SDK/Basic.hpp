...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0772FF18;
	constexpr int32 AppendString      = 0x02891EB0;
	constexpr int32 GNames            = 0x07717680;
	constexpr int32 GWorld            = 0x0787F208;
	constexpr int32 ProcessEvent      = 0x02AAD870;
