...
namespace Offsets
{
	constexpr int32 GObjects          = 0x07774D98;
	constexpr int32 AppendString      = 0x028B65B0;
	constexpr int32 GNames            = 0x0775C500;
	constexpr int32 GWorld            = 0x078C40B8;
	constexpr int32 ProcessEvent      = 0x02AD1FF0;
