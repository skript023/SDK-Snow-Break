...
namespace Offsets
{
	constexpr int32 GObjects          = 0x075086D8;
	constexpr int32 AppendString      = 0x02736CD0;
	constexpr int32 GNames            = 0x074EFE40;
	constexpr int32 GWorld            = 0x07657B88;
	constexpr int32 ProcessEvent      = 0x029526C0;
