...
public:
	...
	uint8                                         Pad_4BC[0x30];                                     // 0x04BC(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UGeometryCacheComponent, NumTracks) == 0x0004B4, "Member 'UGeometryCacheComponent::NumTracks' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, ElapsedTime) == 0x0004B8, "Member 'UGeometryCacheComponent::ElapsedTime' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, Duration) == 0x0004EC, "Member 'UGeometryCacheComponent::Duration' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, bManualTick) == 0x0004F0, "Member 'UGeometryCacheComponent::bManualTick' has a wrong offset!");
