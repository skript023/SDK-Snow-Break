...
static_assert(alignof(SunSky_C_GetHMSFromSolarTime) == 0x000004, "Wrong alignment on SunSky_C_GetHMSFromSolarTime");
static_assert(sizeof(SunSky_C_GetHMSFromSolarTime) == 0x00005C, "Wrong size on SunSky_C_GetHMSFromSolarTime");
...
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, Hour) == 0x000004, "Member 'SunSky_C_GetHMSFromSolarTime::Hour' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, Minute) == 0x000008, "Member 'SunSky_C_GetHMSFromSolarTime::Minute' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, Second) == 0x00000C, "Member 'SunSky_C_GetHMSFromSolarTime::Second' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, ArbitrarySeconds) == 0x000010, "Member 'SunSky_C_GetHMSFromSolarTime::ArbitrarySeconds' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, ArbitraryTime) == 0x000014, "Member 'SunSky_C_GetHMSFromSolarTime::ArbitraryTime' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, TimeFloat) == 0x000018, "Member 'SunSky_C_GetHMSFromSolarTime::TimeFloat' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_FTrunc_ReturnValue) == 0x00001C, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_FTrunc_ReturnValue' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_Percent_IntInt_ReturnValue) == 0x000020, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_Percent_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_Conv_IntToFloat_ReturnValue) == 0x000024, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_Conv_IntToFloat_ReturnValue_1) == 0x000028, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_Conv_IntToFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_Subtract_FloatFloat_ReturnValue) == 0x00002C, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_Subtract_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_Subtract_FloatFloat_ReturnValue_1) == 0x000030, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_Subtract_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_Multiply_IntFloat_ReturnValue) == 0x000034, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_Multiply_IntFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_FTrunc_ReturnValue_1) == 0x000038, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_FTrunc_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_Percent_IntInt_ReturnValue_1) == 0x00003C, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_Percent_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_Conv_IntToFloat_ReturnValue_2) == 0x000040, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_Conv_IntToFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_Divide_FloatFloat_ReturnValue) == 0x000044, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_Divide_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_Subtract_FloatFloat_ReturnValue_2) == 0x000048, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_Subtract_FloatFloat_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_Multiply_IntFloat_ReturnValue_1) == 0x00004C, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_Multiply_IntFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_Add_FloatFloat_ReturnValue) == 0x000050, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_FTrunc_ReturnValue_2) == 0x000054, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_FTrunc_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(SunSky_C_GetHMSFromSolarTime, CallFunc_Percent_IntInt_ReturnValue_2) == 0x000058, "Member 'SunSky_C_GetHMSFromSolarTime::CallFunc_Percent_IntInt_ReturnValue_2' has a wrong offset!");
...
static_assert(sizeof(SunSky_C_UpdateSun) == 0x000180, "Wrong size on SunSky_C_UpdateSun");
...
static_assert(offsetof(SunSky_C_UpdateSun, CallFunc_Add_FloatFloat_ReturnValue) == 0x000018, "Member 'SunSky_C_UpdateSun::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(SunSky_C_UpdateSun, CallFunc_MakeRotator_ReturnValue) == 0x00001C, "Member 'SunSky_C_UpdateSun::CallFunc_MakeRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(SunSky_C_UpdateSun, CallFunc_IsValid_ReturnValue_1) == 0x000028, "Member 'SunSky_C_UpdateSun::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(SunSky_C_UpdateSun, CallFunc_K2_SetWorldRotation_SweepHitResult) == 0x00002C, "Member 'SunSky_C_UpdateSun::CallFunc_K2_SetWorldRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(SunSky_C_UpdateSun, CallFunc_Add_FloatFloat_ReturnValue_1) == 0x0000B8, "Member 'SunSky_C_UpdateSun::CallFunc_Add_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(SunSky_C_UpdateSun, CallFunc_IsDST_IsDST) == 0x0000BC, "Member 'SunSky_C_UpdateSun::CallFunc_IsDST_IsDST' has a wrong offset!");
static_assert(offsetof(SunSky_C_UpdateSun, CallFunc_MakeRotator_ReturnValue_1) == 0x0000C0, "Member 'SunSky_C_UpdateSun::CallFunc_MakeRotator_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(SunSky_C_UpdateSun, CallFunc_K2_SetWorldRotation_SweepHitResult_1) == 0x0000CC, "Member 'SunSky_C_UpdateSun::CallFunc_K2_SetWorldRotation_SweepHitResult_1' has a wrong offset!");
static_assert(offsetof(SunSky_C_UpdateSun, CallFunc_GetSunPosition_SunPositionData) == 0x000158, "Member 'SunSky_C_UpdateSun::CallFunc_GetSunPosition_SunPositionData' has a wrong offset!");
...
static_assert(alignof(SunSky_C_ExecuteUbergraph_SunSky) == 0x000004, "Wrong alignment on SunSky_C_ExecuteUbergraph_SunSky");
static_assert(sizeof(SunSky_C_ExecuteUbergraph_SunSky) == 0x000020, "Wrong size on SunSky_C_ExecuteUbergraph_SunSky");
...
static_assert(offsetof(SunSky_C_ExecuteUbergraph_SunSky, CallFunc_Add_FloatFloat_ReturnValue) == 0x00000C, "Member 'SunSky_C_ExecuteUbergraph_SunSky::CallFunc_Add_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(SunSky_C_ExecuteUbergraph_SunSky, CallFunc_Add_FloatFloat_ReturnValue_1) == 0x000010, "Member 'SunSky_C_ExecuteUbergraph_SunSky::CallFunc_Add_FloatFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(SunSky_C_ExecuteUbergraph_SunSky, CallFunc_NotEqual_FloatFloat_ReturnValue) == 0x000014, "Member 'SunSky_C_ExecuteUbergraph_SunSky::CallFunc_NotEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(SunSky_C_ExecuteUbergraph_SunSky, K2Node_Event_DeltaSeconds) == 0x000018, "Member 'SunSky_C_ExecuteUbergraph_SunSky::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(SunSky_C_ExecuteUbergraph_SunSky, K2Node_SwitchEnum_CmpSuccess) == 0x00001C, "Member 'SunSky_C_ExecuteUbergraph_SunSky::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
