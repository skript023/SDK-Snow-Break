...
TArray<struct FSoftObjectPath> UEmitter_SkillMove_RushToGoal_C::OnGetAssetPath(const TArray<struct FParamInfo>& Values, TArray<int32>& CharacterIDs, TArray<int32>& SkillIDs, TArray<int32>& ModifierIDs, TArray<int32>& EmitterIDs)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Emitter_SkillMove_RushToGoal_C", "OnGetAssetPath");

	Params::Emitter_SkillMove_RushToGoal_C_OnGetAssetPath Parms{};
