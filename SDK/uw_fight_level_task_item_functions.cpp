...
#include "uw_fight_level_task_item_classes.hpp"
#include "uw_fight_level_task_item_parameters.hpp"
...
void Uuw_fight_level_task_item_C::BP_OnItemSelectionChanged(bool bIsSelected)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("uw_fight_level_task_item_C", "BP_OnItemSelectionChanged");

	Params::uw_fight_level_task_item_C_BP_OnItemSelectionChanged Parms{};
...
void Uuw_fight_level_task_item_C::OnListItemObjectSet(class UObject* ListItemObject)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("uw_fight_level_task_item_C", "OnListItemObjectSet");

	Params::uw_fight_level_task_item_C_OnListItemObjectSet Parms{};
...
// LuaFunction uw_fight_level_task_item.uw_fight_level_task_item_C.Destruct
// (BlueprintCosmetic, Native, Event, Public, BlueprintEvent)

void Uuw_fight_level_task_item_C::Destruct()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("uw_fight_level_task_item_C", "Destruct");
...
class FString Uuw_fight_level_task_item_C::GetModuleName() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("uw_fight_level_task_item_C", "GetModuleName");

	Params::uw_fight_level_task_item_C_GetModuleName Parms{};
