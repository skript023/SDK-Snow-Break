...
static_assert(offsetof(AbilityTask_PlayMontageAndWait_OnMontageEnded, InstanceId) == 0x00000C, "Member 'AbilityTask_PlayMontageAndWait_OnMontageEnded::InstanceId' has a wrong offset!");
