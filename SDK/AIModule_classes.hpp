...
static_assert(offsetof(UEnvQueryManager, bUseFindPathAsync) == 0x000140, "Member 'UEnvQueryManager::bUseFindPathAsync' has a wrong offset!");
...
static_assert(offsetof(UCrowdManager, MyNavDatas) == 0x000028, "Member 'UCrowdManager::MyNavDatas' has a wrong offset!");
...
static_assert(offsetof(UCrowdManager, DefaultMaxAgentRadius) == 0x00005C, "Member 'UCrowdManager::DefaultMaxAgentRadius' has a wrong offset!");
static_assert(offsetof(UCrowdManager, MaxAgentRadiuses) == 0x000060, "Member 'UCrowdManager::MaxAgentRadiuses' has a wrong offset!");
