...
static_assert(sizeof(FWM_HID_AxisData) == 0x000098, "Wrong size on FWM_HID_AxisData");
static_assert(offsetof(FWM_HID_AxisData, WM_Settings) == 0x000000, "Member 'FWM_HID_AxisData::WM_Settings' has a wrong offset!");
...
static_assert(offsetof(FWM_HID_AxisData, NormalizedRawValue) == 0x000038, "Member 'FWM_HID_AxisData::NormalizedRawValue' has a wrong offset!");
static_assert(offsetof(FWM_HID_AxisData, CenteredValue) == 0x00003C, "Member 'FWM_HID_AxisData::CenteredValue' has a wrong offset!");
static_assert(offsetof(FWM_HID_AxisData, AxisValue) == 0x000040, "Member 'FWM_HID_AxisData::AxisValue' has a wrong offset!");
static_assert(offsetof(FWM_HID_AxisData, AxisEnum) == 0x000044, "Member 'FWM_HID_AxisData::AxisEnum' has a wrong offset!");
static_assert(offsetof(FWM_HID_AxisData, AxisBindingCode) == 0x000060, "Member 'FWM_HID_AxisData::AxisBindingCode' has a wrong offset!");
static_assert(offsetof(FWM_HID_AxisData, Instance) == 0x000080, "Member 'FWM_HID_AxisData::Instance' has a wrong offset!");
...
static_assert(offsetof(F_PCS_Device, Devices) == 0x000000, "Member 'F_PCS_Device::Devices' has a wrong offset!");
...
static_assert(sizeof(FWM_HID_DPADData) == 0x000148, "Wrong size on FWM_HID_DPADData");
...
static_assert(sizeof(FWM_HID_DeviceInfo) == 0x0000D0, "Wrong size on FWM_HID_DeviceInfo");
