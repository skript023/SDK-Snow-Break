...
public:
	...
	FMulticastInlineDelegateProperty_             OnPostInitializeDelegate;                          // 0x0460(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPreSetupDelegate;                                // 0x0470(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPostSetupDelegate;                               // 0x0480(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPreUpdateDelegate;                               // 0x0490(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPostUpdateDelegate;                              // 0x04A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UControlRigComponent, ControlRigClass) == 0x000458, "Member 'UControlRigComponent::ControlRigClass' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostInitializeDelegate) == 0x000460, "Member 'UControlRigComponent::OnPostInitializeDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPreSetupDelegate) == 0x000470, "Member 'UControlRigComponent::OnPreSetupDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostSetupDelegate) == 0x000480, "Member 'UControlRigComponent::OnPostSetupDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPreUpdateDelegate) == 0x000490, "Member 'UControlRigComponent::OnPreUpdateDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostUpdateDelegate) == 0x0004A0, "Member 'UControlRigComponent::OnPostUpdateDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, MappedElements) == 0x0004B0, "Member 'UControlRigComponent::MappedElements' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bResetTransformBeforeTick) == 0x0004C0, "Member 'UControlRigComponent::bResetTransformBeforeTick' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bResetInitialsBeforeSetup) == 0x0004C1, "Member 'UControlRigComponent::bResetInitialsBeforeSetup' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bUpdateRigOnTick) == 0x0004C2, "Member 'UControlRigComponent::bUpdateRigOnTick' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bUpdateInEditor) == 0x0004C3, "Member 'UControlRigComponent::bUpdateInEditor' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bDrawBones) == 0x0004C4, "Member 'UControlRigComponent::bDrawBones' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, ControlRig) == 0x0004C8, "Member 'UControlRigComponent::ControlRig' has a wrong offset!");
