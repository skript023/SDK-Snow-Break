...
// Package: uw_fight_openshop_item

#include "Basic.hpp"

#include "uw_fight_openshop_item_classes.hpp"
#include "uw_fight_openshop_item_parameters.hpp"
...
// LuaFunction uw_fight_openshop_item.uw_fight_openshop_item_C.InitGamepadLongPressUI
// (Native, Public, BlueprintCallable, BlueprintEvent)

void Uuw_fight_openshop_item_C::InitGamepadLongPressUI()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("uw_fight_openshop_item_C", "InitGamepadLongPressUI");
...
// Function uw_fight_openshop_item.uw_fight_openshop_item_C.GetModuleName
// (Event, Public, HasOutParams, BlueprintCallable, BlueprintEvent, Const)
// Parameters:
// class FString                           ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash)

class FString Uuw_fight_openshop_item_C::GetModuleName() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("uw_fight_openshop_item_C", "GetModuleName");

	Params::uw_fight_openshop_item_C_GetModuleName Parms{};
