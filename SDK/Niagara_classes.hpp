...
public:
	...
	uint8                                         Pad_538[0x24];                                     // 0x0538(0x0024)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UNiagaraComponent, QualityLevelBias) == 0x000534, "Member 'UNiagaraComponent::QualityLevelBias' has a wrong offset!");
static_assert(offsetof(UNiagaraComponent, MaxTimeBeforeForceUpdateTransform) == 0x000560, "Member 'UNiagaraComponent::MaxTimeBeforeForceUpdateTransform' has a wrong offset!");
...
static_assert(offsetof(UNiagaraMeshRendererProperties, bEnableCPUCulling) == 0x0000E4, "Member 'UNiagaraMeshRendererProperties::bEnableCPUCulling' has a wrong offset!");
...
static_assert(sizeof(UNiagaraRibbonRendererProperties) == 0x0007E0, "Wrong size on UNiagaraRibbonRendererProperties");
...
static_assert(offsetof(UNiagaraRibbonRendererProperties, TessellationY) == 0x0000F8, "Member 'UNiagaraRibbonRendererProperties::TessellationY' has a wrong offset!");
static_assert(offsetof(UNiagaraRibbonRendererProperties, bMobileEnableTessellation) == 0x0000FC, "Member 'UNiagaraRibbonRendererProperties::bMobileEnableTessellation' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSpriteRendererProperties, bEnableCPUCulling) == 0x0000E4, "Member 'UNiagaraSpriteRendererProperties::bEnableCPUCulling' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSystem, bDumpDebugSystemInfo) == 0x000048, "Member 'UNiagaraSystem::bDumpDebugSystemInfo' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bDumpDebugEmitterInfo) == 0x000049, "Member 'UNiagaraSystem::bDumpDebugEmitterInfo' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bRequireCurrentFrameData) == 0x00004A, "Member 'UNiagaraSystem::bRequireCurrentFrameData' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, EffectType) == 0x000050, "Member 'UNiagaraSystem::EffectType' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bNeedILC) == 0x000058, "Member 'UNiagaraSystem::bNeedILC' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bOverrideScalabilitySettings) == 0x000059, "Member 'UNiagaraSystem::bOverrideScalabilitySettings' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSystem, bIsLoop) == 0x0000A0, "Member 'UNiagaraSystem::bIsLoop' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bIsComposite) == 0x0000A1, "Member 'UNiagaraSystem::bIsComposite' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, CompositeFlag) == 0x0000A4, "Member 'UNiagaraSystem::CompositeFlag' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bUseDestroyImmediately) == 0x0000A8, "Member 'UNiagaraSystem::bUseDestroyImmediately' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bDestroyImmediately) == 0x0000A9, "Member 'UNiagaraSystem::bDestroyImmediately' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bApplyActorCustomTimeDilation) == 0x0000AA, "Member 'UNiagaraSystem::bApplyActorCustomTimeDilation' has a wrong offset!");
...
static_assert(offsetof(UNiagaraSystem, ExposedParameters) == 0x0002E8, "Member 'UNiagaraSystem::ExposedParameters' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, FixedBounds) == 0x0003B0, "Member 'UNiagaraSystem::FixedBounds' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bAutoDeactivate) == 0x0003CC, "Member 'UNiagaraSystem::bAutoDeactivate' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTime) == 0x0003D0, "Member 'UNiagaraSystem::WarmupTime' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTickCount) == 0x0003D4, "Member 'UNiagaraSystem::WarmupTickCount' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, WarmupTickDelta) == 0x0003D8, "Member 'UNiagaraSystem::WarmupTickDelta' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, bHasSystemScriptDIsWithPerInstanceData) == 0x0003DC, "Member 'UNiagaraSystem::bHasSystemScriptDIsWithPerInstanceData' has a wrong offset!");
static_assert(offsetof(UNiagaraSystem, UserDINamesReadInSystemScripts) == 0x0003E0, "Member 'UNiagaraSystem::UserDINamesReadInSystemScripts' has a wrong offset!");
