...
static_assert(alignof(LevelSequencePlayer_EnableControlPlayerCharacter) == 0x000001, "Wrong alignment on LevelSequencePlayer_EnableControlPlayerCharacter");
static_assert(sizeof(LevelSequencePlayer_EnableControlPlayerCharacter) == 0x000001, "Wrong size on LevelSequencePlayer_EnableControlPlayerCharacter");
static_assert(offsetof(LevelSequencePlayer_EnableControlPlayerCharacter, bValue) == 0x000000, "Member 'LevelSequencePlayer_EnableControlPlayerCharacter::bValue' has a wrong offset!");
