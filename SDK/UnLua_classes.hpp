...
static_assert(sizeof(ULuaFunction) == 0x0000F8, "Wrong size on ULuaFunction");
...
static_assert(sizeof(UUnLuaSettings) == 0x000068, "Wrong size on UUnLuaSettings");
...
static_assert(offsetof(UUnLuaSettings, bLuaEncrypto) == 0x000060, "Member 'UUnLuaSettings::bLuaEncrypto' has a wrong offset!");
